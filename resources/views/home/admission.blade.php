        ...
        <div class="container">
            ...
            <div class="col-md-6 col-sm-12 col-xs-12">
                <div class="n-form-com admiss-form">
                    <div class="col s12">
                        ...
                        <form class="form-horizontal" method='post'  action="{{ route('student.register') }}"  enctype="multipart/form-data" >
            @csrf
            @include('home.layouts.flash_msg')
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" name="mobile" placeholder="Enter your phone number" required>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <!-- <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="education"  placeholder="Enter your education">
                                </div>
                            </div>
                            <div class="form-group">
