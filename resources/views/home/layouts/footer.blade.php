 ...
 <section>
    ...
    <script src="{{ asset('public/material') }}/js/main.min.{{ asset('public/material') }}/js"></script>
    <script src="{{ asset('public/material') }}/js/bootstrap.min.{{ asset('public/material') }}/js"></script>
    <script src="{{ asset('public/material') }}/js/materialize.min.{{ asset('public/material') }}/js"></script>
    <script src="{{ asset('public/material') }}/js/custom.{{ asset('public/material') }}/js"></script>
</body>
